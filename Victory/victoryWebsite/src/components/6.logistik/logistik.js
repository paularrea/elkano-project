      ...
      <div className={styles.bullet_container}>
        ...
        <div className={styles.bullet}>
          ...
          <p>
            ...
            wird, und verringert so die Möglichkeit von Verschleiß oder Verlust.
          </p>
        </div>
        <div className={styles.bullet}>
          <LogistikThree />
        ...
        <div className={styles.bullet}>
          ...
          <p>
            ...
            und den Verbraucher positiv beeinflusst. Unser Team wird Ihnen gerne
            eine massgeschneiderte Lösung anbieten.
          </p>
        </div>
      </div>
      <LogistikImg />
